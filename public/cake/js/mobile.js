 ...
 */
MBP.splash=function(){var filename=navigator.platform==='iPad'?'h/':'l/';document.write('<link rel="apple-touch-startup-image" href="%27+filename+%27splash.png"/*tpa=http://templatation.net/img/%27+filename+%27splash.png*/ />')};
 ...
 */
MBP.startupImage=function(){var portrait;var landscape;var pixelRatio;var head;var link1;var link2;pixelRatio=window.devicePixelRatio;head=document.getElementsByTagName('head')[0];if(navigator.platform==='iPad'){portrait=pixelRatio===2?'startup-tablet-portrait-retina.png'/*tpa=http://templatation.net/Site-templates/Cakery/javascript/img/startup/startup-tablet-portrait-retina.png*/:'startup-tablet-portrait.png'/*tpa=http://templatation.net/Site-templates/Cakery/javascript/img/startup/startup-tablet-portrait.png*/;landscape=pixelRatio===2?'startup-tablet-landscape-retina.png'/*tpa=http://templatation.net/Site-templates/Cakery/javascript/img/startup/startup-tablet-landscape-retina.png*/:'startup-tablet-landscape.png'/*tpa=http://templatation.net/Site-templates/Cakery/javascript/img/startup/startup-tablet-landscape.png*/;link1=document.createElement('link');link1.setAttribute('rel','apple-touch-startup-image');link1.setAttribute('media','screen and (orientation: portrait)');link1.setAttribute('href',portrait);head.appendChild(link1);link2=document.createElement('link');link2.setAttribute('rel','apple-touch-startup-image');link2.setAttribute('media','screen and (orientation: landscape)');link2.setAttribute('href',landscape);head.appendChild(link2)}else{portrait=pixelRatio===2?"startup-retina.png"/*tpa=http://templatation.net/Site-templates/Cakery/javascript/img/startup/startup-retina.png*/:"startup.png"/*tpa=http://templatation.net/Site-templates/Cakery/javascript/img/startup/startup.png*/;link1=document.createElement('link');link1.setAttribute('rel','apple-touch-startup-image');link1.setAttribute('href',portrait);head.appendChild(link1)}};
